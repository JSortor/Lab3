    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (runP == true)
            {
                ...
                Console.WriteLine("\n{0},You entered {1}, lets perform the conditional actions!", firstName,
                    value);
                if (value % 2 == 0 && value >= 2 && value < 25)
                {
                    Console.WriteLine("{0}, You entered {1}, this choice is even and less than 25", firstName, value);
                }
                else if (value % 2 == 0 && value > 25 && value <= 60)
                {
                    Console.WriteLine("{0}, You entered {1}, this choice is even", firstName, value);
                }
                ...
                {
                    Console.WriteLine("{0}, You entered {1}, this choice is odd", firstName, value);
                }
                ...
                {
                    Console.WriteLine("{0}, {1} Is not an integer between 1 and 100", firstName, value);
                }
                else
                {
